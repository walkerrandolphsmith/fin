    ...
    <div className="custom-grid-container relative grid justify-center items-center">
      <div id="custom-grid" className="grid relative gap-3 w-full custom-grid">
        ...
        <GridTile gridArea="A6">
          <MemoizedIconTile
            Icon={A6}
            hasEmphasis={emphasizedTileId === "A6"}
          />
        </GridTile>
        ...
        <GridTile gridArea="B6">
          <MemoizedIconTile
            Icon={B6}
            hasEmphasis={emphasizedTileId === "B6"}
          />
        </GridTile>
        <GridTile gridArea="F4" hasEmphasis={emphasizedTileId === "F4"}>
          <MemoizedIconTile
            Icon={F4}
            hasEmphasis={emphasizedTileId === "F4"}
          />
        </GridTile>
        <GridTile gridArea="E6" hasEmphasis={emphasizedTileId === "E6"}>
          <MemoizedIconTile
            Icon={E6}
            hasEmphasis={emphasizedTileId === "E6"}
          />
        </GridTile>
        <GridTile gridArea="D5">
          <MemoizedIconTile
            Icon={D5}
            hasEmphasis={emphasizedTileId === "D5"}
          />
        </GridTile>
        <ConnectionLines
